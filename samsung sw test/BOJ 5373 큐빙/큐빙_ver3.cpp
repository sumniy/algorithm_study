...
void TurnR()
{
  ...
  // B->D
  temp_qube[DOWN][6] = qube[BACK][2];
  temp_qube[DOWN][3] = qube[BACK][5];
  temp_qube[DOWN][0] = qube[BACK][8];
  // D->F
  temp_qube[FRONT][2] = qube[DOWN][6];
  temp_qube[FRONT][5] = qube[DOWN][3];
  temp_qube[FRONT][8] = qube[DOWN][0];
  // F->U
...
void TurnL()
{
  ...
  // F->D
  temp_qube[DOWN][2] = qube[FRONT][6];
  temp_qube[DOWN][5] = qube[FRONT][3];
  temp_qube[DOWN][8] = qube[FRONT][0];
  // D->B
  temp_qube[BACK][6] = qube[DOWN][2];
  temp_qube[BACK][3] = qube[DOWN][5];
  temp_qube[BACK][0] = qube[DOWN][8];
  // B->U
...
void TurnB()
{
  ...
  temp_qube[DOWN][2] = qube[LEFT][2];
  // D->R
  temp_qube[RIGHT][0] = qube[DOWN][0];
